...
DomainErrorTranslator.directories = {
  ...
  'NEW_THREAD.NOT_LOGIN': new AuthenticationError('tidak dapat membuat thread baru karena belum login'),
  ...
  'NEW_COMMENT.NOT_LOGIN': new AuthenticationError('tidak dapat membuat komentar baru karena belum login'),
};
